...
open_notify= metrics.info('API_open_notify','International Space Station Current Location', latitude=data['iss_position']['latitude'],longitude=data['iss_position']['longitude'])
